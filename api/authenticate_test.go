...
// 		return false
// 	}
// 	err := utils.ConfirmPassword(e.password, arg.HashedPassword)
// 	if err != nil {
// 		return false
// 	}
...
// // 				requireBoadyMatchUser(t, recorder.Body, user)
// // 			},
// // 		},
// // 		{
// // 			name: "InternalError",
...
// func requireBoadyMatchUser(t *testing.T, body *bytes.Buffer, user db.User) {
